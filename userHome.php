    ...
    <main>
        <div id="user-profile">
            ...
            <div id="user-general-info">
                <h4 class="boxHeading">USER: General Info</h4>
                <p><span class="general-info-heading">Member Since </span> 
                <span class="general-info-data"> DATE</span></p>
                <p><span class="general-info-heading">Intersts</span> 
                 <span class="general-info-data">Empty</span></p>
                <p><span class="general-info-heading">Activites</span> 
                 <span class="general-info-data">Empty</span></p>
                <p><span class="general-info-heading">Other Stuff</span> 
                <span class="general-info-data"> Empty</span></p>
            </div>
        </div>
    </main>
